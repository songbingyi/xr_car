...
export class CarListComponent implements OnInit {
    ...
    constructor(private route : ActivatedRoute, private router: Router, private baseService: BaseProvider, private localStorage: LocalStorage, private toastService: ToastService, private dialogService: DialogService, private identityAuthService: IdentityAuthService) {
        this.getInitData();
